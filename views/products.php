                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control" id="productWholesalePrice" name="wholesale_price" min="0" step="0.01" placeholder="Optional">
                            <div class="form-text">Leave blank to disable Wholesale for this item.</div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
